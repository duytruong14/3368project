...
<h2 align="center">View Inventory</h2>
Search for product<input type="text" placeholder="product name..." id="mine" onkeyup="Look()" >
<table id="Table">
    <tr>
        <th>Description</th>
    ...
    <c:forEach var = "listitem" items = "${Productlist}">
        ...
        <tr>
            <td>${listitem.getProductdescription()}</td>
            <td>${listitem.getProductprice ()}</td>
            <td><a href="/deleteproduct/${listitem.getProductid()}"><img src="../../img/delete2.png" style="width:50px;height:50px;" ></a></td>
        </tr>
    </c:forEach>
</table>
<form action="/">
